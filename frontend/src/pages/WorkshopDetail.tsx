  ...
  return (
    <div>
      <div className="flex items-center gap-4 rounded-2xl border border-ceramic-100 bg-white p-6 shadow-sm">
        <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-ceramic-100 text-3xl">
          {w.logo_url ? (
        ...
        <div>
          ...
          {w.address && <p className="text-sm text-gray-600">📍 {w.address}</p>}
      ...
      {w.address && (
        <div className="mt-10">
          ...
          <p className="mt-1 text-sm text-gray-600">📍 {w.address}</p>
