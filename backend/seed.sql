...
from (values
    ('Xưởng Gốm Gia Long', N'Bộ ấm chén men ngọc cao cấp',
     ...
     1250000, 990000, 40, 12, '["/images/Bộ ấm chén men ngọc.jpg"]'),
    ('Xưởng Gốm Gia Long', N'Lọ hoa men lam vẽ tay',
     ...
     850000, NULL, 25, 8, '["/images/Lọ hoa men lam vẽ tay.jpg"]'),
    ('Xưởng Gốm Gia Long', N'Đĩa tráng men rạn nghệ thuật',
     ...
     1450000, 1150000, 15, 5, '["/images/Đĩa tráng men rạn nghệ thuật..webp"]'),
    ('Xưởng Gốm Gia Long', N'Tượng Chú Tiến sĩ gốm truyền thống',
     ...
     1650000, NULL, 10, 3, '["/images/Tượng Chú Tễu gốm truyền thống.jpg"]'),
    ('Xưởng Gốm Gia Long', N'Bộ hũ đựng gia vị men xanh',
     ...
     450000, 380000, 60, 22, '["/images/Bộ hũ đựng gia vị men xanh.png"]'),
    ('Xưởng Gốm Gia Long', N'Lư hương trầm gốm cổ',
     ...
     720000, 650000, 30, 9, '["/images/Lư hương trầm gốm cổ.jpg"]'),
    ('Gốm House Bát Tràng', N'Bộ bát đĩa gia đình 5 người',
     ...
     1890000, 1590000, 50, 18, '["/images/Bộ bát đĩa gia đình 5 người.jpg"]'),
    ('Gốm House Bát Tràng', N'Bộ chén trà thủ công 4 chiếc',
     ...
     520000, 460000, 80, 31, '["/images/Bộ chén trà thủ công 4 chiếc.jpg"]'),
    ('Gốm House Bát Tràng', N'Bình cắm hoa mini men trắng',
     ...
     220000, NULL, 100, 47, '["/images/Ảnh bình hoa mini.PNG"]'),
    ('Gốm House Bát Tràng', N'Mô hình lò gốm Bát Tràng lưu niệm',
     ...
     350000, 290000, 70, 26, '["/images/Mô hình lò gốm Bát Tràng lưu niệm.jpg"]'),
    ('Gốm House Bát Tràng', N'Hũ gốm đựng trà men nâu',
     ...
     380000, 320000, 55, 14, '["/images/Hũ gốm đựng trà men nâu.jpg"]'),
    ('Gốm House Bát Tràng', N'Ly gốm tay cầm gỗ bộ 2',
     ...
     480000, 420000, 65, 19, '["/images/Ly gốm tay cầm gỗ bộ 2 chiếc.jpg"]')
) as p(workshop_name, name, description, theme, material, firing_technique, glaze,
       original_price, sale_price, stock, sold_count, images)
